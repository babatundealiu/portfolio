...
const About:React.FC = () => {
  return (
    <div  id='about'>
      <div className="text-white text-[27px]  xs:text-[12px]  xs:w-[90%] xs:mx-auto sm:text-[16px] justify-center sm:mb-10 sm:mx-auto sm:w-[100%] text-center font-extrabold ">
